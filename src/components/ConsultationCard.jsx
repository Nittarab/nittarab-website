      ...
      <div className="relative bg-gray-900 p-6 rounded-2xl h-full flex flex-col justify-between overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="text-gray-400 text-base mb-6 leading-relaxed">
            ...
            <span className="text-purple-400 font-medium">AI Agents</span>,{" "}
            <span className="text-blue-400 font-medium">Copilot</span>, and{" "}
            <span className="text-green-400 font-medium">Cursor</span>. Expert
            guidance on context engineering and workflow optimization.
          </p>
        </div>
