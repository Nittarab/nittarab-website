  ...
  return (
    <div className="bg-gradient-to-br from-blue-100 to-cyan-100 p-3 rounded-lg shadow-lg border border-white border-opacity-20 transform hover:scale-105 transition-all duration-300 relative overflow-hidden h-28 flex flex-col justify-between">
      <div className="flex items-center space-x-2">
        ...
        <p className="text-sm font-clash-display-bold text-gray-800">Patrick Barattin</p>
      </div>
      <a
        href="https://www.linkedin.com/in/patrick-barattin/"
        target="_blank"
        rel="noopener noreferrer"
        className="block w-full bg-gradient-to-r from-blue-500 to-cyan-500 text-white text-center py-1.5 rounded-full font-clash-display-semibold hover:shadow-lg transition-all duration-300 relative overflow-hidden group"
      >
        <span className="relative z-10 text-xs">Connect</span>
